...
class Widget_Tyche_Companion_Recent extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__( 'Tyche Companion Recent Posts', 'tyche-companion' ), // Name
			array(
				'description'                 => esc_html__( 'Recent Posts!', 'tyche-companion' ),
	...
	public function widget( $args, $instance ) {
		...
		if ( empty( $instance ) ) {
			$instance = array(
				'title'      => esc_attr__( 'Recent Posts', 'tyche-companion' ),
				'show_title' => 'yes',
				'limit'      => 5,
				'offset'     => 0,
				'show_date'  => 'no',
	...
	function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'show_date' ); ?>"><?php _e( 'Show Date', 'tyche-companion' );
				?>:</label>
        ...
        <p>
            <label
                    for="<?php echo $this->get_field_id( 'limit' ); ?>"><?php _e( 'Number of posts', 'tyche-companion' ); ?>
                :</label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'offset' ); ?>"><?php _e( 'Offset', 'tyche-companion' ); ?>
                :</label>

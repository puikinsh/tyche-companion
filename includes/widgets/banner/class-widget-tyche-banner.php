...
class Widget_Tyche_Companion_Banner extends WP_Widget {
	/**
	 * @internal
	 */
	public function __construct() {
		parent::__construct(
			...
			__( 'Tyche Companion Banner', 'tyche-companion' ), // Name
			array( 'description'                 => esc_html__( 'Tyche Companion Banners', 'tyche-companion' ),
	...
	public function widget( $args, $instance ) {
		...
		if ( empty( $instance ) ) {
			$instance = array(
				'title'        => esc_attr__( 'Tyche Companion Banners', 'tyche-companion' ),
				'show_title'   => 'no',
				'image'        => '',
				'image_url'    => '',
				'banner_type'  => 'image',
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'show_title' ); ?>"><?php _e( 'Show Title', 'tyche-companion' );
				?>:</label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'banner_type' ); ?>"><?php _e( 'Banner Type', 'tyche-companion' );
				?>:</label>
            <select name="<?php echo $this->get_field_name( 'banner_type' ); ?>[]"
                ...
                <option value="image" <?php echo ( $banner_type[0] == 'image' ) ? 'selected' : '' ?>>
					<?php echo esc_html__( 'Image', 'tyche-companion' ) ?>
                </option>
                <option value="adsense" <?php echo ( $banner_type[0] == 'adsense' ) ? 'selected' : '' ?>>
					<?php echo esc_html__( 'Adsense', 'tyche-companion' ) ?>
                </option>
            </select>
        </p>

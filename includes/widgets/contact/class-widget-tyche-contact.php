...
class Widget_Tyche_Companion_Contact extends WP_Widget {
	/**
	 * @internal
	 */
	public function __construct() {
		parent::__construct(
			...
			__( 'Tyche Companion Contact Widget', 'tyche-companion' ), // Name
			array(
				'description' => esc_html__( 'Tyche Companion Contact Widget', 'tyche-companion' ),

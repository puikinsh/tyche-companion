...
class Widget_Tyche_Companion_Products extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			__( 'Tyche Companion Products', 'tyche-companion' ), // Name
			array( 'description' => esc_html__( 'Recent Posts!', 'tyche-companion' ),
	...
	public function widget( $args, $instance ) {
		...
		if ( empty( $instance ) ) {
			$instance = array(
				'title'        => esc_attr__( 'Products', 'tyche-companion' ),
				'color'        => 'red',
				'cats'         => array(),
				'show_title'   => 'yes',
				'layout'       => 'layout-c',
	...
	function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title', 'tyche-companion' ); ?>
				:</label>
		...
		<p>
			<label
				for="<?php echo $this->get_field_id( 'show_title' ); ?>"><?php _e( 'Show Title', 'tyche-companion' );
				?>:</label>
			<select name="<?php echo $this->get_field_name( 'show_title' ); ?>[]"
				...
				<option value="yes" <?php echo ( $show_title[0] == 'yes' ) ? 'selected' : '' ?>>
					<?php echo esc_html__( 'Yes', 'tyche-companion' ) ?>
				</option>
				<option value="no" <?php echo ( $show_title[0] == 'no' ) ? 'selected' : '' ?>>
					<?php echo esc_html__( 'No', 'tyche-companion' ) ?>
				</option>
			</select>
		</p>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'color' ); ?>"><?php _e( 'Color', 'tyche-companion' ); ?>
				:</label>
		...
		<p>
			<label
				for="<?php echo $this->get_field_id( 'layout' ); ?>"><?php _e( 'Layout (banner position left/right/no banner/list)', 'tyche-companion' ); ?>
				:</label>
		...
		<select name="<?php echo $this->get_field_name( 'layout' ); ?>"
			...
			<option value="layout-a" <?php echo ( $layout == 'layout-a' ) ? 'selected' : '' ?>>
				<?php echo esc_html__( 'Products with banner on the left side', 'tyche-companion' ) ?>
			</option>
			<option value="layout-b" <?php echo ( $layout == 'layout-b' ) ? 'selected' : '' ?>>
				<?php echo esc_html__( 'Products with banner on the right side', 'tyche-companion' ) ?>
			</option>
			<option value="layout-c" <?php echo ( $layout == 'layout-c' ) ? 'selected' : '' ?>>
				<?php echo esc_html__( 'Products without banner', 'tyche-companion' ) ?>
			</option>
			<option value="layout-d" <?php echo ( $layout == 'layout-d' ) ? 'selected' : '' ?>>
				<?php echo esc_html__( 'Product list', 'tyche-companion' ) ?>
			</option>
		</select>
		...
		<p>
			<label
				for="<?php echo $this->get_field_id( 'first_line' ); ?>"><?php _e( 'Banner First Line', 'tyche-companion' ); ?>
				:</label>
		...
		<p>
			<label
				for="<?php echo $this->get_field_id( 'second_line' ); ?>"><?php _e( 'Banner Second Line', 'tyche-companion' ); ?>
				:</label>
		...
		<p>
			<label
				for="<?php echo $this->get_field_id( 'third_line' ); ?>"><?php _e( 'Banner Third Line', 'tyche-companion' ); ?>
				:</label>
		...
		<p>
			<label
				for="<?php echo $this->get_field_id( 'button_link' ); ?>"><?php _e( 'Banner Button Link', 'tyche-companion' ); ?>
				:</label>
		...
		<p>
			<label
				for="<?php echo $this->get_field_id( 'button_label' ); ?>"><?php _e( 'Banner Button Label', 'tyche-companion' ); ?>
				:</label>
